...
function About() {
    return (
        <>
            ...
            <div className='grid xl:grid-cols-2 lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1 grid-cols-1 mt-16'>
                ...
                <motion.div
                    ...
                    <div>
                     ...
                     <div className='px-10'>
                            ...
                            <div className='grid px-3 md:px-0 md:grid-cols-2 grid-cols-1'>
                                <div className='mt-8'>
